...
import InitialMarkerInputHandler from '../inputs/InitialMarkerInputHandler.js';

import FSANodeRenderer from '../renderer/FSANodeRenderer.js';
import InitialMarkerLayer from '../components/InitialMarkerLayer.js';

class FSAGraphView extends React.Component
{
    constructor(props)
    {
        super(props);
    ...
    componentDidMount()
    {
        ...
        context.addInputHandler(new InitialMarkerInputHandler(inputController, graphController));
        ...
        return (
            <React.Fragment>
                ...
                <GraphEdgeLayer edges={graph.getEdges()}
                    ...
                    onMouseOver={onMouseOver}
                    onMouseOut={onMouseOut} />
                <InitialMarkerLayer node={graph.getStartNode()}
                    inputController={inputController}
                    onMouseOver={onMouseOver}
                    onMouseOut={onMouseOut} />
