...
import {MACHINE_ERROR_NOTIFICATION_TAG} from 'modules/cfg/components/notifications/CFGNotifications.js';
...
class TestingPanel extends React.Component
{
    ...
    onAutoErrorCheckChange(e)
    {
        ...
        else
        {
            ...
            errorChecker.onGrammarChange(machineController.getMachine());
        }
    }
