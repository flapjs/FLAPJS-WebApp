...
import { GRAPH_EVENT_EDGE_EDIT_WHILE_DELETE, GRAPH_EVENT_EDGE_DELETE, GRAPH_EVENT_EDGE_CREATE } from '@flapjs/services/graph/controller/inputhandler/GraphEdgeInputHandler.js';
    ...
    emitGraphEvent(eventName, eventData)
    {
        ...
        switch (eventName)
        {
            ...
            case GRAPH_EVENT_EDGE_EDIT_WHILE_DELETE:
                // FIXME: This should notify the notification manager.
                /*
