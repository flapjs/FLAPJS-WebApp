    ...
    return <button className="toolbar-button" id="toolbar-new"
      ...
      <svg className="navicons"
        ...
        <g id="Material" display="none">
          <path display="inline" d="M14,2H6C4.9,2,4,2.9,4,4v16c0,1.1,0.89,2,1.99,2H18c1.1,0,2-0.9,2-2V8L14,2z M16,16h-3v3h-2v-3H8v-2h3v-3 h2v3h3V16z M13,9V3.5L18.5,9H13z"/>
        </g>
      </svg>
    </button>;
  }
