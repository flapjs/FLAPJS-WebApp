      ...
      <button className="export-button" onClick={this.onClick.bind(this)}>
        <svg className="export-icon" viewBox="0 0 56 56">
          ...
          <g>
            ...
            <g>
              <path fill="#9777A8" d="M19.5,19v-4c0-0.551,0.448-1,1-1c0.553,0,1-0.448,1-1s-0.447-1-1-1c-1.654,0-3,1.346-3,3v4
              ...
              <path fill="#9777A8" d="M39.5,21c-1.103,0-2-0.897-2-2v-4c0-1.654-1.346-3-3-3c-0.553,0-1,0.448-1,1s0.447,1,1,1
              ...
              <path fill="#9777A8" d="M27.5,24c-0.553,0-1,0.448-1,1v3c0,0.552,0.447,1,1,1s1-0.448,1-1v-3
